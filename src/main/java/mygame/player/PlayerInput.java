...
public class PlayerInput extends AdapterControl implements ActionListener {
    ...
    public boolean isRunning() {
        return playerControl.isRunning;
    }

    public boolean isWalking() {
        return playerControl._MoveLeft || playerControl._MoveRight || playerControl._MoveForward || playerControl._MoveBackward;
    }
    ...
    public void onAction(String action, boolean keyPressed, float tpf) {
        ...
        }else if (action.equals(KeyMapping.JUMP)) {
            playerControl._Jump = keyPressed;
