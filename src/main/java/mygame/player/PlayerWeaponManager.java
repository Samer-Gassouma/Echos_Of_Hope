...
public class PlayerWeaponManager extends AdapterControl implements ActionAnimEventListener {
    ...
    private void configureAnimClips() {
        ...
        animator.actionCycleDone(Archer.Walking);
        animator.actionCycleDone(Archer.Jump);
    ...
    public void switchWeapon() {
        ...
        switch (currentWeapon.weaponType) {
            ...
            case Bow:
                ...
                Spatial arrow = assetManager.loadModel("Models/Arrow/military_bombs_on_gaza.glb");
