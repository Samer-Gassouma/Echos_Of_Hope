...
public interface AnimDefs {
    ...
    public interface Archer {
        ...
        final Animation3 Walking        = new Animation3("Walking", true);
        final Animation3 Jump              = new Animation3("Jump", false);
    ...
    public interface Monster {
        ...
        final Animation3 Idle               = new Animation3("React", true);
        final Animation3 ReactFront         = new Animation3("React", false);
        final Animation3 Death              = new Animation3("Dying", false);
    }
